...
public partial class LlamaParseClient
{
         ...
         ResultType resultType)
    {
        ...
        public async Task<StructuredResult> GetStructuredResult(ResultType type, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var results = await client.GetJobStructuredOutputAsync(id, type, cancellationToken);
                return results;
            }
